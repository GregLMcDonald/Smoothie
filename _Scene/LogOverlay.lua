...
local function createLogEntryDisplay( entry, rowNumber )
	...
	local ratingObj = require( '_UI.RatingDisplay').new( rating )
	...
	local comment = display.newImageRect( '__image/ui/chatGreenFilled.png', 40, 40)
...
function scene:create( event )
	...
	--local close = display.newImageRect( '__image/ui/arrows.png', 30, 30 )
	--close.x = -143

	local close = display.newImageRect( '__image/ui/kitchen.png', 30, 30 )
	close.x = 143
