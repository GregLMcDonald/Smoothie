...
local function addAppliances()
	...
	local appliances = {
    	...
    	require( 'Appliance.Grinder' ).new(),
    	require( 'Appliance.Press' ).new(),
    	require( 'Appliance.Dummy' ).new(),
    }
...
local function addHomeButton()
    ...
    function homeButton:tap()
        ...
        composer.gotoScene( 'Scene.Title', { effect = 'crossFade', time = 300 } )
    end
...
function scene:create( event )
    ...
    self.preferences = event.params.preferences
...
function scene:show( event )
    ...
    elseif ( phase == "did" ) then
        ...
        composer.removeScene( 'Scene.LogOverlay' )
...
function scene:logButtonTapped( event )
    ...
    composer.showOverlay( 'Scene.LogOverlay' , { isModal = true, time = 0, params = { log = log} })
end
